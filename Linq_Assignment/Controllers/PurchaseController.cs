...
namespace Linq_Assignment.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        public ActionResult ProductName_4()
        {
            using (ShopEntities db = new ShopEntities())
            {
                List<Product> products = db.Products.ToList();
        ...
        // GET: Purchase
        public ActionResult CustomerReport_2()
        {
            using (ShopEntities db = new ShopEntities())
            {
                List<Customer> customers = db.Customers.ToList();
        ...
        public ActionResult ProductReport_3()
        {
            using (ShopEntities db = new ShopEntities())
            {
                List<Product> products = db.Products.ToList();
        ...
        public ActionResult MaximumPrice_5()
        {
